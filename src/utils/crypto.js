...
var MD5 = {
	...
	b64_hmac_md5: function(k, d) { return this.rstr2b64(this.rstr_hmac_md5(str2rstr_utf8(k), this.str2rstr_utf8(d))); },
	any_hmac_md5: function(k, d, e) { return this.rstr2any(this.rstr_hmac_md5(str2rstr_utf8(k), this.str2rstr_utf8(d)), e); },
